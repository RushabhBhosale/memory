...
private const val EXPENSE_CHANNEL_ID = "memonest_expense_sms"
const val EXPENSE_ACTION_ADD = "com.anonymous.memonest.EXPENSE_ADD"
const val EXPENSE_ACTION_IGNORE = "com.anonymous.memonest.EXPENSE_IGNORE"
  ...
  fun notifyPendingTransaction(context: Context, transaction: JSONObject) {
    ...
    val notification =
      Notification.Builder(context, EXPENSE_CHANNEL_ID)
        ...
        .setContentTitle(if (type == "credit") "Memonest Income" else "Memonest Expense")
        .setContentText(body)
